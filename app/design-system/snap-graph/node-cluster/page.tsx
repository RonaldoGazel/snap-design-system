    ...
    <div className="min-h-screen snap-canvas p-12 flex items-center justify-center">
      ...
      <div className="relative">
        ...
        <div 
          ...
          style={{ opacity: 0.30, top: '20px', left: '-20px', height: '110px' }}
        >
        ...
        <div 
          className="absolute w-64 rounded-lg border border-canvas-node-border overflow-hidden bg-canvas-node"
          style={{ opacity: 0.50, top: '10px', left: '-10px', height: '110px' }}
        >
          <div className="flex h-full">
            <div className="w-1 h-full" style={{ backgroundColor: ENTITY_COLOR }} />
          </div>
        ...
        <div className="relative w-64 rounded-lg overflow-hidden border border-canvas-node-border shadow-sm bg-canvas-node" style={{ height: '110px' }}>
          <div className="flex h-full">
